  ...
  return (
    ...
    >
      ...
      <div className="basis-1/4 bg-transparent">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                ...
                />
                <span className="rounded-l-none rounded-md bg-gray-200 p-2 text-gray-600">
                  %
                </span>
              </div>
            </div>
        ...
        <button
          className="absolute bottom-4 right-4 rounded-md bg-red-500 px-4 py-2 text-sm text-white shadow-sm hover:bg-red-600"
          type="button"
